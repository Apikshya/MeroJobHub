...
import { FileText, CheckCircle, UploadCloud, Loader2, FileEdit, Image, Paperclip } from 'lucide-react';
...
export default function MyDocuments() {
  ...
  const getFileIcon = (fileType) => {
    ...
    if (type === 'doc' || type === 'docx') return <FileEdit className="w-6 h-6 text-blue-500" />;
    if (type === 'png' || type === 'jpg' || type === 'jpeg') return <Image className="w-6 h-6 text-purple-500" />;
