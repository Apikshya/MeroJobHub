...
export default function UserList() {
  ...
  const handleFormChange = (e) => {
    ...
    // if (["firstName", "middleName", "lastName", "first_Name", "middle_Name", "last_Name"].includes(name)) {
  ...
  // User type badge (coloured, like before)
...
// ——— Helper components (unchanged, but using your classes) ———
